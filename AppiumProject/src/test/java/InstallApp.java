...
public void install() throws MalformedURLException
{
	...
	//dc.setCapability(MobileCapabilityType.APP, "‪D:\\Testyanthra\\Appiumsoftware\\ApiDemos-debug.apk");
	URL url=new URL("http://localhost:4723/wd/hub");
	AndroidDriver driver=new AndroidDriver(url,dc);
	driver.installApp("D:\\Testyanthra\\Appiumsoftware\\ApiDemos-debug.apk");
	driver.launchApp();
